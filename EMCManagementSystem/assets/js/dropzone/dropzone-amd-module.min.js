...
function (a) {
    ...
    function () {
        var c, e, f, g, h, i, j, k, l = {}.hasOwnProperty,
        m = function (a, b) {
            function c() {
                this.constructor = a
            }
                ...
                c.onload = function (d) {
                    return function () {
                        ...
                        e.onload = function () {
                            ...
                            i(f, e, null != (j = g.srcX) ? j : 0, null != (k = g.srcY) ? k : 0, g.srcWidth, g.srcHeight, null != (l = g.trgX) ? l : 0, null != (m = g.trgY) ? m : 0, g.trgWidth, g.trgHeight),
        ...
        c.discover = function () {
            ...
            a(document.getElementsByTagName("div")), a(document.getElementsByTagName("form"))), g = [], e = 0, f = d.length; f > e; e++) b = d[e],
        ...
        c.isBrowserSupported = function () {
            var a, b, d, e, f;
            if (a = !0, window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) if ("classList" in document.createElement("a")) for (f = c.blacklistedBrowsers, d = 0, e = f.length; e > d; d++) b = f[d],
            b.test(navigator.userAgent) && (a = !1);
            else a = !1;
            else a = !1;
            return a
        },
        ...
        i = function (a, b, c, d, e, f, g, i, j, k) {
            var l;
            return l = h(b),
            a.drawImage(b, c, d, e, f, g, i, j, k / l)
        },
        g = function (a, b) {
