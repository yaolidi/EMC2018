...
function (t, e) {
    ...
    function r(n, r, c) {
        ...
        function f() {
            oe = r.theme ? "ui" : "fc",
            n.addClass("fc"),
            n.addClass(r.isRTL ? "fc-rtl" : "fc-ltr"),
        ...
        function w(e) {
            he++,
            ie && (te("viewDestroy", ie, ie, ie.element), B(), ie.triggerEventDestroy(), G(), ie.element.remove(), ne.deactivateButton(ie.name)),
            ne.activateButton(e),
            ie = new me[e](t("<div class='fc-view block fc-view-" + e + "' style='position:relative'/>").appendTo(ae), ee),
            C(),
            $(),
            he--
        }
        ...
        function M(t) {
            he++,
            ie.start && (te("viewDestroy", ie, ie, ie.element), B(), N()),
            G(),
            ie.render(ge, t || 0),
            S(),
            $(),
    ...
    function o(n, r) {
            ...
            function (a) {
                if (r == R) {
                    if (a) {
                        ...
                        for (var o = 0; o < a.length; o++) a[o].source = e,
                        b(a[o]);
                        W = W.concat(a)
                    }
                    N--,
        ...
        function s(e, r) {
            ...
            var l = e.events;
            if (l) t.isFunction(l) ? (m(), l(d(T), d(E),
            function (t) {
                r(t),
                y()
            })) : t.isArray(l) ? r(l) : r();
        ...
        function f(t) {
            ...
            for (e = 0; r > e; e++) n = W[e],
            n._id == t._id && n != t && (n.start = new Date(+n.start + o), n.end = t.end ? new Date(n.end ? +n.end + i : +a(n) + i) : null, n.title = t.title, n.url = t.url, n.allDay = t.allDay, n.className = t.className, n.editable = t.editable, n.color = t.color, n.backgroundColor = t.backgroundColor, n.borderColor = t.borderColor, n.textColor = t.textColor, b(n));
            b(t),
            k(W)
        }
        function v(t, e) {
        ...
        function b(t) {
            ...
            t._id = t._id || (t.id === e ? "_fc" + be++ : t.id + ""),
        ...
        function D(t) {
            t.className ? "string" == typeof t.className && (t.className = t.className.split(/\s+/)) : t.className = [];
            for (var e = pe.sourceNormalizers,
    ...
    function E(e, n, r) {
        for (var a, o = 0; o < e.length; o++) a = t(e[o]),
    ...
    function Z(e, n, r) {
        ...
        function o() {
            ...
            ge = be("columnFormat"),
            pe = be("weekNumbers"),
            me = be("weekNumberTitle"),
            ye = "iso" != be("weekNumberCalculation") ? "w" : "W"
        }
        function i() {
        ...
        function u() {
            ...
            r = "";
            for (r += "<thead><tr>", pe && (r += "<th class='fc-week-number " + n + "'>" + q(me) + "</th>"), t = 0; ne > t; t++) e = Ee(0, t),
            r += "<th class='fc-day-header fc-" + De[e.getDay()] + " " + n + "'>" + q(ke(e, ge)) + "</th>";
            return r += "</tr></thead>"
        }
        function v() {
            ...
            for (a += "<tbody>", t = 0; ee > t; t++) {
                for (a += "<tr class='fc-week'>", pe && (n = Ee(t, 0), a += "<td class='fc-week-number " + r + "'><div>" + q(ke(n, ye)) + "</div></td>"), e = 0; ne > e; e++) n = Ee(t, e),
                a += h(n);
                a += "</tr>"
            }
            return a += "</tbody>"
        ...
        function h(t) {
            ...
            +t == +r ? o.push("fc-today", he + "-state-highlight") : o.push(r > t ? "fc-past" : "fc-future"),
            a += "<td class='" + o.join(" ") + "' data-date='" + ke(t, "yyyy-MM-dd") + "'><div>",
        ...
        function g(e) {
            ...
            "variable" == be("weekMode") ? n = r = Math.floor(o / (1 == ee ? 2 : 6)) : (n = Math.floor(o / ee), r = o - n * (ee - 1)),
            J.each(function (e, o) {
        ...
        function p(t) {
            ...
            de.clear(),
            te = 0,
            pe && (te = _.find("th.fc-week-number").outerWidth()),
            K = Math.floor(($ - te) / ne),
            E(Y.slice(0, -1), K)
        }
        function y(t) {
        ...
        ke = n.formatDate;
        B(e.addClass("fc-grid")),
        oe = new ue(function (e, n) {
            var r, a, o;
            Y.each(function (e, i) {
                r = t(i),
                a = r.offset().left,
    ...
    function K(n, r, a) {
        ...
        function c() {
            ...
            re = K.find("tbody"),
            oe = re.find("td").slice(0, -1),
            ie = oe.find("> div"),
            se = oe.find(".fc-day-content > div"),
            de = oe.eq(0),
            he = ie.eq(0),
            P(ee.add(ee.find("tr"))),
            P(re.add(re.find("tr")))
        ...
        function g() {
            ...
            a = "";
            for (a += "<thead><tr>", Je ? (e = sn(t, Ue), Pe ? e += Ve : e = Ve + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + q(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; Ae > n; n++) t = rn(0, n),
            a += "<th class='fc-" + De[t.getDay()] + " fc-col" + n + " " + r + "'>" + q(sn(t, Xe)) + "</th>";
        ...
        function p() {
            ...
            s = f(new Date),
            l = "";
            for (l += "<tbody><tr><th class='fc-agenda-axis " + o + "'>&nbsp;</th>", n = "", e = 0; Ae > e; e++) t = rn(0, e),
            a = ["fc-col" + e, "fc-" + De[t.getDay()], i],
            +t == +s ? a.push(Be + "-state-highlight", "fc-today") : a.push(s > t ? "fc-past" : "fc-future"),
        ...
        function b(e) {
            ...
            me && (n = n.add(me.find("th:first"))),
            n = n.add(Me.find("th:first")),
            ke = 0,
            E(n.width("").each(function (e, n) {
            ...
            Fe = be.width() - a,
            Fe ? (E(r, Fe), r.show().prev().removeClass("fc-last")) : r.hide().prev().addClass("fc-last"),
            He = Math.floor((a - ke) / Ae),
            E(ne.slice(0, -1), He)
        }
        function D() {
            function t() {
        ...
        function T(t) {
            if (!Ze("selectable")) {
                ...
                if (r) {
                    ...
                    o = Math.floor(a / 60);
                    n.setHours(o),
                    n.setMinutes(a % 60 + je),
                    Ge("dayClick", oe[e], n, !1, t)
        ...
        function _(t, n) {
            ...
            o = Math.floor(a / r),
            i = ln[o];
            return i === e && (i = ln[o] = Me.find("tr").eq(o).find("td div")[0].offsetTop),
            ...
            if (1 == e.which && Ze("selectable")) {
                ...
                _e.start(function (t, e) {
                    if (V(), t && t.col == e.col && !A(t)) {
                        var r = L(e),
                        a = L(t);
                        n = [r, u(d(r), Ne), a, u(d(a), Ne)].sort(O),
                        J(n[0], n[3])
                    } else n = null
                },
                e),
                ...
                function (t) {
                    _e.stop(),
                    n && (+n[0] == +n[1] && Z(n[0], !1, t), Ke(n[0], n[3], !1, t))
                })
            }
        }
        function Z(t, e, n) {
        ...
        function G(t, e) {
            _e.start(function (t) {
                if (Qe(), t) if (A(t)) k(t.row, t.col, t.row, t.col);
                else {
                    var e = L(t),
        ...
        sn = r.formatDate,
        ln = {};
        B(n.addClass("fc-agenda")),
        Le = new ue(function (e, n) {
            function r(t) {
            ...
            i[1] = o + a.outerWidth(),
            Ze("allDaySlot") && (a = ye, o = a.offset().top, e[0] = [o, o + a.outerHeight()]);
    ...
    function te() {
        ...
        function a(e) {
            ...
            p = t.map(e, i),
            m = [];
            for (r = 0; v > r; r++) for (n = Y(0, r), u(n, h), a = ee(o(e, p, n, u(d(n), g - h))), ne(a), s = 0; s < a.length; s++) for (l = a[s], c = 0; c < l.length; c++) f = l[c],
            f.col = r,
            f.level = s,
            m.push(f);
            return m
        ...
        function s(n, r) {
            ...
            N = "",
            z = F();
            for (k = (S = y("isRTL")) ? -1 : 1, a = 0; H > a; a++) o = n[a],
            i = o.event,
            s = A(o.start, o.start),
            l = A(o.start, o.end),
            u = o.col,
            ...
            g = _(u) - h,
            g = Math.min(g - 6, .95 * g),
            p = d ? g / (d + v + 1) : v ? 2 * (g / (v + 1) - 6) : g,
            m = h + g / (d + v + 1) * d * k + (S ? g - p : 0),
            o.top = s,
            o.left = m,
            o.outerWidth = p,
            o.outerHeight = l - s,
            N += c(i, o);
            for (z[0].innerHTML = N, D = z.children(), a = 0; H > a; a++) o = n[a],
            i = o.event,
            w = t(D[a]),
            C = b("eventRender", i, i, w),
            C === !1 ? w.remove() : (C && C !== !0 && (w.remove(), w = t(C).css({
                position: "absolute",
                top: o.top,
                left: o.left
            }).appendTo(z)), o.element = w, i._id === r ? f(i, w, o) : w[0]._fci = a, U(i, w));
            for (T(z, n, f), a = 0; H > a; a++) o = n[a],
            (w = o.element) && (o.vsides = R(w, !0), o.hsides = x(w, !0), M = w.find(".fc-event-title"), M.length && (o.contentTop = M[0].offsetTop));
            for (a = 0; H > a; a++) o = n[a],
            (w = o.element) && (w[0].style.width = Math.max(0, o.outerWidth - o.hsides) + "px", E = Math.max(0, o.outerHeight - o.vsides), w[0].style.height = E + "px", i = o.event, o.contentTop !== e && E - o.contentTop < 10 && (w.find("div.fc-event-time").text(ie(i.start, y("timeFormat")) + " - " + i.title), w.find("div.fc-event-title").remove()), b("eventAfterRender", i, i, w))
        }
        function c(t, e) {
            var n = "<",
            r = t.url,
            ...
            return D(t) && o.push("fc-event-draggable"),
            ...
            n += " class='" + o.join(" ") + "' style='position:absolute;top:" + e.top + "px;left:" + e.left + "px;" + a + "'><div class='fc-event-inner'><div class='fc-event-time'>" + q(se(t.start, t.end, y("timeFormat"))) + "</div><div class='fc-event-title'>" + q(t.title || "") + "</div></div><div class='fc-event-bg'></div>",
            e.isEnd && w(t) && (n += "<div class='ui-resizable-handle ui-resizable-s'>=</div>"),
            n += "</" + (r ? "a" : "div") + ">"
        }
        function f(t, e, n) {
        ...
        function v(t, e, n) {
            ...
            e.draggable({
                ...
                start: function (n, p) {
                    ...
                    u.start(function (n, a) {
                        if (te(), n) {
                            ...
                            p = Y(0, n.col);
                            i = h(p, u),
                            n.row ? s ? c && (e.width(f - 10), S(e, v * Math.round((t.end ? (t.end - t.start) / Me : y("defaultEventMinutes")) / g)), e.draggable("option", "grid", [f, 1]), c = !1) : o = !0 : (K(l(d(t.start), i), l(C(t), i)), r()),
                            o = o || c && !i
                        } else r(),
                        o = !0;
                ...
                stop: function (n, a) {
                    if (u.stop(), te(), b("eventDragStop", e, t, n, a), o) r(),
                    e.css("filter", ""),
                    Z(t, e);
                    else {
                        var s = 0;
                        c || (s = Math.round((e.offset().top - V().offset().top) / v) * g + p - (60 * t.start.getHours() + t.start.getMinutes())),
                        $(this, t, i, s, c, n, a)
                    }
                }
            })
        ...
        function g(t, e, n) {
            function r() {
                te(),
                s && (f ? (n.hide(), e.draggable("option", "grid", null), K(l(d(t.start), D), l(C(t), D))) : (a(w), n.css("display", ""), e.draggable("option", "grid", [S, x])))
            }
            function a(e) {
            ...
            e.draggable({
                ...
                revertDuration: y("dragRevertDuration"),
                start: function (n, r) {
                    b("eventDragStart", e, t, n, r),
                    G(t, e),
                    T.build(),
                    o = e.position(),
                    i = T.cell(n.pageX, n.pageY),
                    s = c = !0,
                    f = v = O(i),
                    g = p = 0,
                    D = 0,
                ...
                drag: function (t, n) {
                    ...
                    } (s != c || f != v || g != p || w != M) && (r(), c = s, v = f, p = g, M = w),
                    e.draggable("option", "revert", !s)
                },
                stop: function (n, a) {
                    te(),
                    b("eventDragStop", e, t, n, a),
                    s && (f || D || w) ? $(this, t, D, f ? 0 : w, f, n, a) : (s = !0, f = !1, g = 0, D = 0, w = 0, r(), e.css("filter", ""), e.css(o), Z(t, e))
                }
            })
        }
        function p(t, e, n) {
    ...
    function ne(t) {
        var e, n, r, a, o, i;
        for (e = t.length - 1; e > 0; e--) for (a = t[e], n = 0; n < a.length; n++) for (o = a[n], r = 0; r < t[e - 1].length; r++) i = t[e - 1][r],
        re(o, i) && (i.forward = Math.max(i.forward || 0, (o.forward || 0) + 1))
    }
    function re(t, e) {
    ...
    function ae(n, r, a) {
        ...
        function A(t) {
            var e = B.visStart.getDay();
            return t += e,
            Math.floor(t / 7) * G + K[(t % 7 + 7) % 7] - K[e]
        }
        function O(t) {
            var e = B.getColCnt(),
            n = ee ? -1 : 1,
        ...
        B.opt = o,
        B.trigger = i,
        B.isEventDraggable = s,
        B.isEventResizable = c,
        B.setEventData = f,
        B.clearEventData = v,
        B.eventEnd = g,
        B.reportEventElement = p,
        B.triggerEventDestroy = m,
        B.eventElementHandlers = y,
        B.showEvents = b,
        B.hideEvents = D,
        B.eventDrop = C,
        B.eventResize = M;
        ...
        B.dateToCell = z,
        B.dateToDayOffset = W,
        B.dayOffsetToCellOffset = A,
        B.cellOffsetToCell = O,
        B.cellToDate = H,
        B.cellToCellOffset = F,
        B.cellOffsetToDayOffset = R,
        B.dayOffsetToDate = N,
        B.rangeToSegments = L,
        B.segmentCompare = _;
        var G, $ = o("hiddenDays") || [],
    ...
    function oe() {
        ...
        function o(t) {
            for (var e = t.start,
            n = C(t), r = ee(e, n), a = 0; a < r.length; a++) r[a].event = t;
            return r
        }
        function i(t) {
        ...
        function c(t) {
            ...
            !r.allDay && t.isStart && (e += "<span class='fc-event-time'>" + q(G(r.start, r.end, S("timeFormat"))) + "</span>"),
        ...
        function D(t, e, n) {
            H(t) && E.draggableDayEvent(t, e, n),
            n.isEnd && F(t) && E.resizableDayEvent(t, e, n),
            z(t, e)
        }
        function w(t, e) {
            var n, r = te();
        ...
        var E = this;
        E.renderDayEvents = e,
        E.draggableDayEvent = w,
        E.resizableDayEvent = M;
        var S = E.opt,
        k = E.trigger,
    ...
    t.fn.fullCalendar = function (n) {
        ...
        n = t.extend(!0, {},
        he, n.isRTL || n.isRTL === e && he.isRTL ? ge : {},
        n),
