...
function OpenDoc2() {
    ...
    openDocObj.EditDocument("http://119.29.8.149:8060/php/分页.docx");
  
   // url = "http://119.29.8.149:8066/file/123.docx";
   //// oframe.Open(url);
   // oframe.Open("http://119.29.8.149:8066/file/123.docx", false, "Word.Document");
   // oframe.Open(url,false);
    //oframe.showdialog(1);
     //"/Doc/0/Doc/0163.docx oframe.Open(url, false)
}
function SaveCopyDoc() {
    if (!CheckFileOpened()) return;
    oframe.showdialog(3);
}
function SaveCopyDoc2() {
    oframe.Save("c:\\1.doc", true);
    ...
    //    WebFile2.UploadFile(tempFile2, "http://119.29.8.149:8060/php/");
    //    alert("上传成功！");
    //} catch (e) {
