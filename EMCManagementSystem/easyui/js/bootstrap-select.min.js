    ...
    a.prototype = {
        ...
        init: function () {
            ...
            if (d !== undefined) {
                ...
                this.$button.attr("style", "border:1px solid;border-color: #cccccc");
        ...
        createDropdown: function () {
            ...
            var d = '<div class="btn-group bootstrap-select' + c + '"><button type="button" class="btn dropdown-toggle selectpicker" data-toggle="dropdown"' + g + '><span class="filter-option pull-left" id="span_id"></span>&nbsp;<span class="caret"></span></button><div class="dropdown-menu open">' + f + e + '<ul class="dropdown-menu inner selectpicker" role="menu"></ul></div></div>';
            return b(d)
        },
        createView: function () {
        ...
        createLi: function () {
            ...
            b.each(e,
            function (f, g) {
                c += "<li onclick='op(this)' rel=" + f + ">" + g + " </li>"
            });
